...
namespace mar {
	namespace editor {
		...
		std::vector<std::vector<maths::vec3>> filesystem::s_angles;
		std::vector<std::vector<maths::vec3>> filesystem::s_scales;
		std::vector<std::vector<maths::vec3>> filesystem::s_colors;
		std::vector<std::vector<std::string>> filesystem::s_textures;
		...
		void filesystem::loadSceneFromFile(std::string path) {
