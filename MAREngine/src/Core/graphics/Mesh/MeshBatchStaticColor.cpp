...
namespace marengine {
	...
	void FMeshBatchStaticColor::submitRenderableComponent(const RenderableComponent& renderableComponent) {
	...
	void FMeshBatchStaticColor::submitTransformComponent(const TransformComponent& transformComponent) {
