...
namespace marengine {
	...
	/*
		FEventsComponentEntity is event class for entity components. With this we can define
		events for specific component action. Newly defined components should create own
		templated methods.
	*/
	...
	public:
		...
		/*
			Event called everytime, when TComponent is added to entity. Remember, method actually adds component!
		...
		*/
		...
		/*
			Event called everytime, when TComponent is removed from entity. Remember, method actually removes component!
