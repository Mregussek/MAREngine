...
namespace marengine {
    ...
    void FContentBrowserImGui::create(FImGuiEditorServiceLocator* serviceLocator) {
        m_pMeshManager = serviceLocator->retrieve<FImGuiTypeHolder<FMeshManager*>>()->pInstance;
