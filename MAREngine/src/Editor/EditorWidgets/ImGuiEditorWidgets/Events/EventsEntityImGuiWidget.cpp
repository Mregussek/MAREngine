...
namespace marengine {
    ...
    void FEventsEntityImGuiWidgets::create(FSceneManagerEditor* pSceneManagerEditor, FInspectorImGuiWidget* pInspectorWidget) {
        s_pSceneManagerEditor = pSceneManagerEditor;
        s_pInspectorWidget = pInspectorWidget;
    }
